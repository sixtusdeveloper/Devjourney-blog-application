...
const page = async () => {
  ...
  return (
    <>
      <section
        className="relative md:mt-12 mt-10 md:py-4 px-6 min-h-screen lg:min-h-[430px] flex items-center justify-center bg-cover bg-center"
        style={{
      ...
      >
        ...
        <div className="relative z-10 text-white text-center px-4 space-y-6 max-w-4xl">
          ...
          <Link href="/">
            <button className="mt-4 px-6 py-3 mx-auto bg-gradient-to-r from-green-600 via-indigo-500 to-purple-700 text-white flex items-center cursor-pointer tracking-wide text-lg font-semibold rounded-md shadow-lg transition duration-300">
              Explore Now
            </button>
          </Link>
        </div>
